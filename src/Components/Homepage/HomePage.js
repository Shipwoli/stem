...
communication and presentational skills shaping them to leaders.
      ...
      <Button variant="primary" href="tournament">Learn More</Button>
    </Col>
  </Row>
  <Row className="align-items-center my-5">
    ...
    <Col md={6} className="order-md-1">
      ...
      <Button variant="primary" href="afterschool">Learn More</Button>
    </Col>
  </Row>
  <Row className="align-items-center my-5">
    <Col md={6}>
    ...
    <Col md={6}>
      ...
      <Button variant="primary" href="lab">Learn More</Button>
    </Col>
  </Row>
  <Row className="align-items-center my-5">
    <Col md={6} className="order-md-2">
    ...
    <Col md={6} className="order-md-1">
      ...
      <Button variant="primary" href="centre">Learn More</Button>
    </Col>
  </Row>
</Container>
